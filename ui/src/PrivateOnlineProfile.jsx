...
class PrivateOnlineProfile extends React.Component {
  ...
  async loadData() {
    ...
    const data = await PrivateOnlineProfile.fetchData(match, null, showError);
...
PrivateOnlineProfile.contextType = UserContext;

const OnlineProfileEditWithToast = withToast(PrivateOnlineProfile);
OnlineProfileEditWithToast.fetchData = PrivateOnlineProfile.fetchData;
